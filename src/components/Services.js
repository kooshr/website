  ...
  return (
    <div id='projects' className='h-screen'>
      ...
      <div className='flex flex-col items-center w-screen align-middle h-5/6 justify-evenly'>
        ...
        {/*AWS URL: https://www.credly.com/badges/5ae7035a-93af-40db-896e-32232d65bf6d/public_url*/}
        <div class="h-1/4 w-5/6 rounded-lg bg-gradient-to-r from-primaryblue  to-primaryred p-1 hover:scale-105 transition-all duration-200">
          <a href='https://github.com/kooshr/FoodLine'>
            <div class=" h-full w-full bg-gray-800 rounded-lg relative group">
              <div className="absolute top-0 block w-1/2 h-full transform -skew-x-12 -inset-full z-5 bg-gradient-to-r from-transparent to-bgblack opacity-40 group-hover:animate-shine" />
              <h className='pl-5 mt-5 text-4xl font-bold text-center text-transparent drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.2)] bg-gradient-to-r from-primaryblue to-primaryred bg-clip-text '>
                FoodLine
              ...
              <ul className='pl-10 list-disc'>
                <li>
                  Developed a React Native mobile app, "FoodLine," for an online food marketplace.
                </li>
                <li>
                  Integrated features such as user registration, real-time product listings, and streamlined order management.
                </li>
                <li>
                  Utilized Firebase Firestore for real-time data updates and Expo libraries for enhanced user experiences, including image uploading and camera access.
                </li>
              </ul>
              <div className='absoulte bg-gradient-to-tr from-primaryblue to-primaryred w-[108px] h-[105px] ml-[1208px] mt-[-80px] rounded-lg' />
              <div className='w-[108px] h-[105px] ml-[1200px] mt-[-115px] rounded-lg bg-bgblack'>
                <img src='assets/foodline.png' alt="Img not Found. Maybe Reload?" className='w-[108px] h-[105px] rounded-lg' />
              </div>
            </div>
          </a>
        </div>
